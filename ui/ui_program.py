...
#         self.label_top.setFixedSize(260, 260)
...
#         self.label_bottom.setFixedSize(260, 260)
...
#         self.save_preset_button1.setText("프리셋 1 저장")
...
#         self.save_preset_button2.setText("프리셋 2 저장")
...
#         self.save_preset_button3.setText("프리셋 3 저장")
...
#         self.load_preset_button1.setText("프리셋 1 로드")
...
#         self.load_preset_button2.setText("프리셋 2 로드")
...
#         self.red_text.setText(_translate("Dialog", "Red Level"))
#         self.blue_text.setText(_translate("Dialog", "Blue Level"))
#         self.green_text.setText(_translate("Dialog", "Green Level"))
    
#     def update_red_value_ui(self, value):
#         self.red_value_level.setText(f"{value}")
#         self.apply_filters()

#     def update_blue_value_ui(self, value):
#         self.blue_value_level.setText(f"{value}")
#         self.apply_filters()

#     def update_green_value_ui(self, value):
#         self.green_value_level.setText(f"{value}")
#         self.apply_filters()
    
#     def apply_filters(self):
#         red_level = self.red_slider.value()
#         blue_level = self.blue_slider.value()
#         green_level = self.green_slider.value()
        
#         img = cv2.imread('./pic.jpg')
#         filtered_img = apply_color_filter(img, red_level, green_level, blue_level)

#         qimage = QtGui.QImage(filtered_img.data, filtered_img.shape[1], filtered_img.shape[0], filtered_img.strides[0], QtGui.QImage.Format_RGB888)
...
#         presets[f'preset{num}'] = preset
#         with open('presets.json', 'w') as f:
#             json.dump(presets, f)
#         QMessageBox.information(None, "프리셋 저장", f"프리셋 {num}이(가) 성공적으로 저장되었습니다.")
    
#     def load_preset(self, num):
#         presets = self.load_presets_from_file()
#         preset = presets.get(f'preset{num}')
#         if preset:
#             self.red_slider.setValue(preset['red'])
#             self.green_slider.setValue(preset['green'])
#             self.blue_slider.setValue(preset['blue'])
#             QMessageBox.information(None, "프리셋 로드", f"프리셋 {num}이(가) 성공적으로 로드되었습니다.")
#         else:
#             QMessageBox.warning(None, "프리셋 로드", f"프리셋 {num}을(를) 찾을 수 없습니다.")
